...
bot_info = ' This bot is a property of UndefinedCookiee,' \
           ' a framework by @undefinedcookiee for Telegram payments released under the' \
           ' ' \
           '\n'
...
error_empty_cart = "You didn't add any products to your cart."
